...
export default function EditMinistryPage({ params }: { params: { id: string } }) {
  ...
  const initialLeaders = membersData.filter(member => ministry.leader.includes(member.name));

  const [leaders, setLeaders] = React.useState<Member[]>(initialLeaders);
      ...
      <Card className="max-w-3xl mx-auto">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Input id="ministry-name" defaultValue={ministry.name} />
          </div>
          <div className="space-y-2">
