    ...
    return (
        <main className="flex-1 space-y-6 p-4 sm:p-8 bg-muted/20">
            <div className="flex items-center gap-4">
                ...
                <div>
                <h1 className="text-3xl font-bold tracking-tight">Añadir Nueva Donación</h1>
                <p className="text-muted-foreground">
                    Ingrese los detalles para el nuevo registro de donación.
                </p>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="donor-search" placeholder="Buscar un donante existente..." className="pl-9" />
                            </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea id="notes" placeholder="Añada cualquier nota relevante, como el número de cheque o detalles de donación anónima." rows={3} />
                        </div>
                        ...
                        <div className="flex justify-end gap-2 pt-4">
                            ...
                            <Button>Guardar Donación</Button>
                        </div>
                    </div>
                </CardContent>
            </Card>
