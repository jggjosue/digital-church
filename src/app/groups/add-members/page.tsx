...
export default function AddMembersToGroupPage() {
  const [selectedMembers, setSelectedMembers] = React.useState<number[]>([1, 3]);
        ...
        description={
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild><Link href="/groups">Grupo de Jóvenes</Link></BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Agregar Miembros</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
        }
      ...
      <div className="space-y-4 max-w-5xl mx-auto">
        {showSuccess && (
            <Alert variant="default" className="bg-green-50 border-green-200 text-green-900">
                ...
                <AlertDescription>
                    Los miembros seleccionados han sido agregados exitosamente al grupo.
                </AlertDescription>
            </Alert>
        )}
        {showError && (
             <Alert variant="destructive">
                ...
                <AlertDescription>
                    No se pudieron agregar los miembros. Por favor, intente de nuevo.
                </AlertDescription>
            </Alert>
        )}
        ...
        <Card>
            <CardHeader>
                <CardTitle>Seleccionar Miembros para Agregar</CardTitle>
                <CardDescription>
                    Busque miembros de la iglesia y selecciónelos para agregarlos al grupo. Los miembros que ya están en el grupo no se muestran.
                </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="overflow-x-auto">
                    <Table>
                        ...
                        <TableBody>
                            {membersData.slice(0, 4).map((member) => (
